...
cfg.train.sampling_mode = 'random'  # choose between 'random' and 'patch'
...
cfg.train.render_sep_plane = False
...
# loss
cfg.loss = CN()
cfg.loss.normal_l1_weight = 1.
cfg.loss.normal_cos_weight = 1.
...
parser.add_argument('--render_mesh', type=str, default='')
